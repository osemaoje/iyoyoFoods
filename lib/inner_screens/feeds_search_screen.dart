...
class FeedsSearchScreen extends StatefulWidget {
  static const routeName = "/FeedsSearchScreenState";

  const FeedsSearchScreen({Key? key}) : super(key: key);

  @override
  State<FeedsSearchScreen> createState() => _FeedsSearchScreenState();
}

class _FeedsSearchScreenState extends State<FeedsSearchScreen> {
