...
import 'package:payment/screens/address/add_address_page.dart';
...
import 'package:payment/widgets/empty_screen.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return cartItemsList.isEmpty
        ? const EmptyScreen(
            ...
            subtitle: 'Get some Delicious Meals',
            buttonText: 'Shop now',
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            ...
                            Column(
                              children: [
                                Text(
                                  cartItemsList.length.toString() + ' items',
                                  style: TextStyle(
                                      color: Colors.white,
                                      fontWeight: FontWeight.bold,
                                      fontSize: 16),
